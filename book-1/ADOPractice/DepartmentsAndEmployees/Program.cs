...
namespace DepartmentsAndEmployees
{
    class Program
    {
        ...
        public static void PrintDepartmentReport(string title, List<Department> departments)
        {
            ...
            {
                Console.WriteLine($"{singleDept.Id}: {singleDept.DeptName}");
            };
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            {
                if (singleEmployee.Department == null)
                {
        ...
        */
                ...
                {
                    Console.WriteLine($"{singleEmployee.Id}: {singleEmployee.FirstName} {singleEmployee.LastName}. Dept: {singleEmployee.Department.DeptName} ");
